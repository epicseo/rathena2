# rAthena Script Commands Complete Reference v5.0

**Version:** 5.0 Enhanced - Fully Parsed from Source
**Commands:** 598 commands fully documented  
**Source:** doc/script_commands.txt (rAthena official documentation)
**RAG-Optimized:** Yes - with chunk markers and navigation
...
This is a comprehensive reference for ALL rAthena script commands, fully parsed from the official documentation. Each command includes:
- Complete syntax signature
- Full description from official docs
...
| Category | Commands |
|----------|----------|
| **Basic I/O** | mes, next, close, menu, select, input |
| **Variables** | set, setd, getd, setarray, copyarray |
| **Flow Control** | if, switch, while, for, goto, end |
| **Items** | getitem, delitem, countitem, getitemname |
| **Player** | warp, heal, statusup, skilleffect |
| **Status** | sc_start, sc_end, getstatus, bonus |
| **NPCs** | donpcevent, enablenpc, disablenpc |
| **Mobs** | monster, killmonster, mobcount |
| **Math** | rand, pow, sqrt, min, max |
| **Strings** | mes, sprintf, explode, implode |

---



<!-- RAG_CHUNK: commands_a -->
## Commands: A
...
For more good examples see just about

*[Documentation truncated - see doc/script_commands.txt for full details]*
...
Example 1:
	...
	OnTimer10000:
		...
		detachnpctimer;
		// and remember attachnpctimer and de
...
correctly handle an NPC trader fo
...
Example 2: check party count (with a 'next' pause), before warping to event
	...
	// loop through both and use 'islo
...
Example of sending mail with items and random options:
	...
	.@zeny = 0;
	setarray .@mailitem[0], 504, 505, 2220, 1214; // White Potion, Blue Potion, Hat, Dagger
	setarray .@mailamount[0], 10, 5, 1, 1; // 10 White Potions, 5 Blue Potions, 1 Hat, 
...
This will create you an array .@menulist$ which contains the text
...
instead of hardcoding the HTML-like tags. For more details see the documentat
...
Examples:
	...
	sc_end_class(getcharid(0),Job_Arch_Bis
