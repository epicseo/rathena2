...
total_commands: 767
categories: 15
original_lines: 10222
optimizations:
  - Enhanced YAML front-matter
  - Comprehensive Table of Contents
  - Alphabetical command index
  - Related commands cross-references
  - Internals notes for timer/memory commands
  - Memory safety warnings
  - Enhanced code examples with comments
  - Standardized code block formatting
  - Instance/Battleground details merged
description: |
  Complete reference documentation for all rAthena script commands.
  Includes syntax, parameters, return values, examples, and cross-references.
  Optimized for RAG systems with comprehensive metadata and linking.
see_also:
