# rAthena Source Development Complete Reference v8.0 Ultimate

**Version:** 8.0 Ultimate
**Coverage:** Code Structure, Best Practices, Plugin System, Security, Memory Safety
**Last Updated:** 2025-11-26

---

# ═══════════════════════════════════════════════════════════════
# PART 1: SOURCE CODE STRUCTURE
# ═══════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════
# PART 5: MEMORY SAFETY & CRASH PATTERNS
# ═══════════════════════════════════════════════════════════════
---
kb_id: KB_REF_031
